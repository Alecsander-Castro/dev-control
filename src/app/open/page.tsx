...
export default function OpenTicket() {
  ...
  async function handleSearchedCustomer(data: FormData) {
      ...
      <main className="flex flex-col mt-4 mb-2">
        {customer ? (
          ...
          <form
            ...
            onSubmit={handleSubmit(handleSearchedCustomer)}
          >
            <div className="flex flex-col gap-3">
              ...
              <button
                type="submit"
                className="bg-blue-500 flex flex-row gap-3 px-2 h-11 rounded items-center justify-center text-white font-bold"
              >
                Procurar cliente
